...
const GamePage = () => {
  return (
    <div className="bg-[url(/assets/images/background-mobile.svg)] md:bg-[url(/assets/images/background-tablet.svg)] lg:bg-[url(/assets/images/background-desktop.svg)] bg-cover bg-center h-screen relative flex flex-col items-center">
      ...
      {/* Guesses */}
      <div className="flex items-center flex-col gap-2 md:gap-6 w-full px-6 md:px-12 md:mt-[100px]">
        <div className="mt-40 grid grid-cols-9 gap-2">
            <div className="w-[29px] h-[45px] md:w-[64px] md:h-[84px] bg-[#3d73fb] flex justify-center rounded-xl md:rounded-[24px] relative">
                <div className="w-[25px] h-[41px] md:w-[58px] md:h-[78px] bg-[#2463FF] rounded-xl md:rounded-[24px] text-white grid place-content-center text-[28px] md:text-[48px] absolute bottom-0">U</div>
            </div>
            <div className="w-[29px] h-[45px] md:w-[64px] md:h-[84px] bg-[#3d73fb] flex justify-center rounded-xl md:rounded-[24px] relative">
                <div className="w-[25px] h-[41px] md:w-[58px] md:h-[78px] bg-[#2463FF] rounded-xl md:rounded-[24px] text-white grid place-content-center text-[28px] md:text-[48px] absolute bottom-0">N</div> 
            </div>
            <div className="w-[29px] h-[45px] md:w-[64px] md:h-[84px] bg-[#3d73fb] flex justify-center rounded-xl md:rounded-[24px] relative">
                <div className="w-[25px] h-[41px] md:w-[58px] md:h-[78px] bg-[#2463FF] rounded-xl md:rounded-[24px] text-white grid place-content-center text-[28px] md:text-[48px] absolute bottom-0">I</div>
            </div>
            <div className="w-[29px] h-[45px] md:w-[64px] md:h-[84px] bg-[#2f1e83] flex justify-center rounded-xl md:rounded-[24px] relative">
                <div className="w-[25px] h-[41px] md:w-[58px] md:h-[78px] bg-[#261676] rounded-xl md:rounded-[24px] text-white grid place-content-center text-[28px] md:text-[48px] absolute bottom-0"></div>
            </div>
            <div className="w-[29px] h-[45px] md:w-[64px] md:h-[84px] bg-[#2f1e83] flex justify-center rounded-xl md:rounded-[24px] relative">
                <div className="w-[25px] h-[41px] md:w-[58px] md:h-[78px] bg-[#261676] rounded-xl md:rounded-[24px] text-white grid place-content-center text-[28px] md:text-[48px] absolute bottom-0"></div>
            </div>
            <div className="w-[29px] h-[45px] md:w-[64px] md:h-[84px] bg-[#3d73fb] flex justify-center rounded-xl md:rounded-[24px] relative">
                <div className="w-[25px] h-[41px] md:w-[58px] md:h-[78px] bg-[#2463FF] rounded-xl md:rounded-[24px] text-white grid place-content-center text-[28px] md:text-[48px] absolute bottom-0">D</div>
            </div>
        </div>
      </div>
      {/* Letters */}
      <div className="w-full px-6 md:px-12 mt-[120px] grid gap-6">
        ...
        <div className="grid grid-cols-9 translate-x-4 md:translate-x-9 z-10">
