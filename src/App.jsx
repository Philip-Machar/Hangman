...
const App = () => {
  ...
  const categories = [{id: nanoid(), name: "MOVIES"}, {id: nanoid(), name: "TV SHOWS"}, {id: nanoid(), name: "COUNTRIES"}, {id: nanoid(), name: "CAPITAL CITIES"}, {id: nanoid(), name: "ANIMALS"}, {id: nanoid(), name: "SPORTS"}];
